import 'package:vag_helper_assistant/app/common/headers.dart';
import 'package:vag_helper_assistant/app/modules/chat_image/views/widgets/image_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Vag Assistant Images'),
        centerTitle: true,
        leading: IconButton(
          onPressed: () {
            Get.back();
